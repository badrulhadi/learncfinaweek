				...
				<div id="about">
					...
					<div class="clr">
						...
						<div class="right">
							...
							<div class="clr"><div class="input-box">E-mail</div><span><a href="#application.utilities.convertStringToASCII(personalInfo.email)#">#personalInfo.email#</a></span>  </div>
